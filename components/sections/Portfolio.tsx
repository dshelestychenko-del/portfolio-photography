      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            ...
            <span className="text-orange-500"> {portfolioContent.titleAccent}</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredItems.map((item, index) => (
            <div 
              ...
              className={`group cursor-pointer overflow-hidden rounded-3xl bg-gray-50 transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 ${
            ...
            >
              <div className={`relative overflow-hidden ${
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-orange-50 to-gray-100 opacity-60 group-hover:opacity-40 transition-opacity duration-300"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-500 text-lg">Portfolio Shot</p>
                  </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                  <div className="text-white">
                    <p className="text-sm uppercase tracking-wider mb-2 text-orange-300">
                      {item.category}
                    </p>
              ...
              <div className="p-6">
                <div className="flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 bg-orange-100 rounded-full flex items-center justify-center group-hover:bg-orange-500 transition-colors duration-300">
                    <div className="w-5 h-5 bg-orange-500 rounded-full group-hover:bg-white transition-colors duration-300"></div>
                  </div>
                </div>
